...
module.exports = {
	...
	execute: async (bot, msg, args, cfg) => {
		...
		case "prefix":
			...
			return "Prefix changed to " + prefix + "\nThis means that all commands must now be preceded by your chosen prefix rather than `pika!`. If this was changed by mistake, run `" + prefix + "cfg prefix pika!` to return to default behavior.";
